...
import { BoxGeometry, ConeGeometry, Float32BufferAttribute, Fog, Group, Mesh, MeshStandardMaterial, PCFShadowMap, PCFSoftShadowMap, PlaneGeometry, PointLight, RepeatWrapping, SphereGeometry } from 'three'
...
const bricksAmbientOcclusionexture = textureLoader.load('/textures/bricks/ambientOcclusion.jpg')
const bricksNormalTexture = textureLoader.load('/textures/bricks/normal.jpg')
const bricksRoughnessTexture = textureLoader.load('/textures/bricks/roughness.jpg')

const grassColorTexture = textureLoader.load('/textures/grass/color.jpg')
const grassAmbientOcclusionexture = textureLoader.load('/textures/grass/ambientOcclusion.jpg')
...
grassAmbientOcclusionexture.repeat.set(8, 8)
grassAmbientOcclusionexture.wrapS = RepeatWrapping
grassAmbientOcclusionexture.wrapT = RepeatWrapping
...
house.add(walls, roof, door, bush, bush1, bush2, bush3)
...
const ghost = new PointLight('#ff00ff', 2, 3)
scene.add(ghost)

const ghost1 = new PointLight('#00ffff', 2, 3)
scene.add(ghost1)
...
const tick = () =>
{
    ...
    ghost1.position.y = Math.sin(ghostAngle1 * 4) + Math.sin(elapsedTime * 2.5)

    const ghostAngle2 = - elapsedTime * 0.18
    ghost2.position.x = Math.cos(ghostAngle2) * (7 + Math.sin(elapsedTime * 0.32))
    ghost2.position.z = Math.sin(ghostAngle2) * (7 + Math.sin(elapsedTime * 0.32))
    ghost2.position.y = Math.sin(elapsedTime * 5) + Math.sin(elapsedTime * 0.32)
