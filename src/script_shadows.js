...
import { PlaneGeometry, CameraHelper, MeshBasicMaterial, PointLight, SpotLight, SpotLightHelper, TextureLoader } from 'three'
...
const tick = () =>
{
    ...
    sphere.position.y = Math.abs(Math.sin(elapsedTime * Math.PI))
